            ...
            _.each(value, function(ele, index) {
                var template = _.template(
                    '<li class="list-settings-item">' +
                        ...
                        '<a href="#" class="remove-action remove-setting" data-index="<%= index %>"><span class="icon fa fa-times-circle" aria-hidden="true"></span><span class="sr">Remove</span></a>' + //jshint ignore:line
                    '</li>'
                );
