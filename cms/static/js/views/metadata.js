            ...
            _.each(value, function(ele, index) {
                var template = _.template(
                    '<li class="list-settings-item">' +
                        ...
                        '<a href="#" class="remove-action remove-setting" data-index="<%= index %>"><span class="icon fa fa-times-circle" aria-hidden="true"></span><span class="sr">Remove</span></a>' +
                    '</li>'
                );
            ...
            _.each(value, function(value, key) {
                var template = _.template(
                    '<li class="list-settings-item">' +
                        ...
                        '<a href="#" class="remove-action remove-setting" data-value="<%= value %>"><span class="icon fa fa-times-circle" aria-hidden="true"></span><span class="sr">Remove</span></a>' +
                    '</li>'
                );
